  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-900 via-green-800 to-green-950 flex flex-col items-center justify-start px-4 py-10">
      ...
      <header className="w-full max-w-2xl flex flex-col items-center mb-6">
        ...
        {/* Decorative divider with wheat/leaf motif */}
...
function CarrotIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
      {/* Carrot body */}
      <path
        d="M20 16 C16 24 14 36 18 48 C20 54 26 58 30 56 C34 54 38 48 38 40 C42 32 44 20 40 14 C36 8 24 8 20 16Z"
        fill="#f97316"
      />
      {/* Carrot highlight */}
      <path
        d="M26 18 C24 24 23 32 24 40"
        stroke="#fed7aa"
        strokeWidth="2.5"
        strokeLinecap="round"
      />
      {/* Leaves */}
      <path
        d="M30 14 C28 6 20 4 16 8 C20 10 26 14 30 14Z"
        fill="#16a34a"
      />
      <path
        d="M30 14 C32 4 42 2 44 8 C40 10 34 14 30 14Z"
        fill="#15803d"
      />
      <path
        d="M30 14 C30 6 34 0 38 4 C36 8 32 12 30 14Z"
        fill="#22c55e"
      />
    </svg>
  );
